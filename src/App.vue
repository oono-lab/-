<template>
  <div id="app" class="chat-container">
    ...
    <div class="notice">
      ...
      ・2個のサイコロを同時に投げるとき、出る目の和が４になる確率を求めよ。<br />
      ・１から１００までの番号をつけた１００枚のカードから１枚を取り出すとき、その番号が４の倍数または６の倍数である確率を求めよ。<br />
      ・１５本のくじの中に当たりくじが５本ある。この中から２本のくじを同時に引くとき、少なくとも１本が当たる確率を求めよ。<br />
      ・１個のさいころと１枚の硬貨を投げるとき、さいころは６の約数の目が出て、硬貨は表が出る確率を求めよ。<br />
      現在はこれらの問題文のみ対応しています。
    </div>
  </div>
</template>
